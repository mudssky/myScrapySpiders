...
# from getchu.items import getchu_item.join_and_strip
# from getchu.items import *  # noqa: F403
...
class getchuIDSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if tab_type == 'game':
            ...
            l = getchu_item.ItemLoader(item=getchu_item.GetchuItem(), response=response)
            l.add_value('tab_type', tab_type)
